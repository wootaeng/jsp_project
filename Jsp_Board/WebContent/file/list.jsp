...
<div class="container">
	...
	<a class="btn btn-outline-secondary" href="private/uploadform.jsp" role="button">업로드 하러가기</a>
	<h1>자료실 목록 입니다.</h1>
	...
	<nav>
		<ul class="pagination justify-content-center">
			<c:choose>
				<c:when test="${tmp.startPageNum ne 1}">
					<li class="page-item">
				...
				<c:choose>
					<c:when test="${i eq pageNum }">
						<li class="page-item active">
							<a class="page-link" href="list?pageNum=${i }&condition=${conditon }&keyword=${encodedK}">${i }</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class="page-item">
