 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" >
 	<div class="container">
	  	<a class="navbar-brand" href="${pageContext.request.contextPath }/">
	  		<img style="width:50px;height:50px" src="${pageContext.request.contextPath }/images/chat.png"/> 
	  	</a>
		...
		<div class="collapse navbar-collapse" id="topNav">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item <%=thisPage.equals("cafe") ? "active" : "" %>">
					<a class="nav-link" href="${pageContext.request.contextPath }/cafe/list">게시글 목록</a>
				</li>
				<li class="nav-item <%=thisPage.equals("file") ? "active" : "" %>">
					<a class="nav-link" href="${pageContext.request.contextPath }/file/list">자료실</a>
				</li>
			</ul>
			<%
			//로그인된 아이디가 있는지 읽어와본다
